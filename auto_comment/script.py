...
# # 使用你的 API Key
# #api key 9
# openai.api_key = "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"
...
#         temperature=0.5,
#     )
#     print("code annotated successfully")
...
# # 将注释后的代码写入文件
# with open("code_out.txt", "w") as output_file:
#     output_file.write(annotated_code)
